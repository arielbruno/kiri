...
[![Build Status](https://travis-ci.org/arielbruno/kiri.svg?branch=master)](https://travis-ci.org/arielbruno/kiri)
...
6. If you did everything correct, https://arielbruno.github.io/kiri/ will lead to your new docs
...
- Documentation(ReDoc): https://arielbruno.github.io/kiri/
- SwaggerUI: https://arielbruno.github.io/kiri/swagger-ui/
- Look full spec:
    + JSON https://arielbruno.github.io/kiri/swagger.json
    + YAML https://arielbruno.github.io/kiri/swagger.yaml
- Preview spec version for branch `[branch]`: https://arielbruno.github.io/kiri/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://arielbruno.github.io/kiri/ with url from the message: `Server started <url>`
